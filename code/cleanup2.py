...
sourcePath = r"/home/Tiffany/ENGL598/samples/raw/" #replace with file path to folder with source files
destPath = r"/home/Tiffany/ENGL598/samples/stripped/test/" #replace with file path to where you want
...
#Define a function to change or delete unwanted characters
	...
	f = open(r'/home/Tiffany/ENGL598/samples/test/' + fileName, 'w')
	f.write(result)
	f.close()